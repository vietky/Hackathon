            ...
            <div className="ad-itemx__image col-4">
              <img src={this.props.item.images.length > 0 ? this.props.item.images[0] : ''} alt="" />
              {
                this.props.item.voice_description && this.props.item.id === this.props.playingTrack.id ?
                  ...
                  (<svg className="ad-itemx__image-player" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M128 104.3v303.4c0 6.4 6.5 10.4 11.7 7.2l240.5-151.7c5.1-3.2 5.1-11.1 0-14.3L139.7 97.2c-5.2-3.3-11.7.7-11.7 7.1z"></path></svg>)
              }
            </div>
