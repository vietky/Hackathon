    ...
    return (
      <div id="recorder" className="form-group row" >
          ...
          <div className="col-sm-9">
            <button id="recorder-btn-record" title="Record" className={`recorder-btn`} onClick={this.record}>
          ...
          <button id="recorder-btn-play" title="Continue record" className={`recorder-btn ${this.disabled(!this.state.recording)}`} onClick={this.play}>
