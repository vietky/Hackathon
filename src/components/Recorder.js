    ...
    return (
      <div id="recorder" className="form-group row" >
        ...
        <div className="col-sm-9">
          ...
          <button id="recorder-btn-record" title="Record" className={`recorder-btn ${this.disabled(this.state.recording)}`} onClick={this.record}>
          ...
          <button id="recorder-btn-end" title="Pause" className={`recorder-btn ${this.disabled(!this.state.recording)}`} onClick={this.stop}>
          ...
          <button id="recorder-btn-play" title="Play" className={`recorder-btn ${this.disabled(this.state.recording)}`} onClick={this.play}>
